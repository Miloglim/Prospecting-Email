...
import {
  ...
  SettingOutlined, UploadOutlined, HistoryOutlined, UnorderedListOutlined,
...
const navGroups: { items: NavItem[] }[] = [
  ...
  },
  {
    items: [
      ...
      { key: "/queue", icon: <UnorderedListOutlined />, label: "发送队列" },
  ...
  {
    items: [
      { key: "/import", icon: <UploadOutlined />, label: "导入客户" },
    ],
  },
];
